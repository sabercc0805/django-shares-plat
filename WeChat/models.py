...
class Accountuser(models.Model):
    ...
    password = models.CharField(db_column='PassWord', max_length=48, blank=True, null=True)  # Field name made lowercase.
    precent = models.IntegerField(db_column='Precent', blank=True, null=True)  # Field name made lowercase.
...
class Acount(models.Model):
    acountname = models.CharField(db_column='AcountName', primary_key=True, max_length=256)  # Field name made lowercase.
